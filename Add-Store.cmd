...
for /f %%i in ('dir /b *VCLibs*UWP*.appx 2^>nul ^| find /i "x64"') do set "VCLibsUWPX64=%%i"
for /f %%i in ('dir /b *VCLibs*UWP*.appx 2^>nul ^| find /i "x86"') do set "VCLibsUWPX86=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.4*.appx 2^>nul ^| find /i "x64"') do set "UIXaml24X64=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.4*.appx 2^>nul ^| find /i "x86"') do set "UIXaml24X86=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.7*.appx 2^>nul ^| find /i "x64"') do set "UIXaml27X64=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.7*.appx 2^>nul ^| find /i "x86"') do set "UIXaml27X86=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.8*.appx 2^>nul ^| find /i "x64"') do set "UIXaml28X64=%%i"
for /f %%i in ('dir /b *UI.Xaml*2.8*.appx 2^>nul ^| find /i "x86"') do set "UIXaml28X86=%%i"
...
if /i %arch%==x64 (
set "DepStore=%VCLibsX64%,%VCLibsX86%,%VCLibsUWPX64%,%VCLibsUWPX86%,%Framework6X64%,%Framework6X86%,%Runtime6X64%,%Runtime6X86%,%UIXaml24X64%,%UIXaml24X86%,%UIXaml27X64%,%UIXaml27X86%,%UIXaml28X64%,%UIXaml28X86%"
set "DepPurchase=%VCLibsX64%,%VCLibsX86%,%VCLibsUWPX64%,%VCLibsUWPX86%,%Framework6X64%,%Framework6X86%,%Runtime6X64%,%Runtime6X86%,%UIXaml28X64%,%UIXaml28X86%"
set "DepXbox=%VCLibsX64%,%VCLibsX86%,%Framework6X64%,%Framework6X86%,%Runtime6X64%,%Runtime6X86%"
set "DepInstaller=%VCLibsX64%,%VCLibsX86%,%UIXaml27X64%,%UIXaml27X86%"
) else (
